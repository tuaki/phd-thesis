...
% [TOC title], label, title, authors, publication
\newcommand*{\paperChapter}[5][]{%
\refstepcounter{chapter}%
% This code is straight from latex2e source.
% Well, there just `#3` instead of `\ifx...' in the source. However, this leads to overlapping of the title and the chapter number in the TOC, so we have to fix this with a custom TOC title.
...
#5
% {\it #5\ifx&#6&\else,\par doi: \href{https://doi.org/#6}{#6}\fi}
