...
% The paper can be referenced separately from the paper chapter. This is important forr the thesis report, where the paper chapters are not included, but the list of publications is.
\label{pub:#1}%
