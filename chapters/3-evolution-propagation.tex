...
Overall, the existing literature is strong in isolated parts of the problem---some approaches focus on schema evolution, others on migration strategies, query rewriting, and workload-aware tuning. What is still largely missing is a unified treatment of evolution as propagation across a genuinely multi-model representation with explicit conceptual schema, logical models, mappings, data instances, and queries. Our approach builds on a shared categorical representation, supports all major model combinations through explicit mappings, and extends propagation not only to data but also to queries, including difficult cases with decreasing information capacity.
