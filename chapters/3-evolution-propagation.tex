...
\begin{figure}[ht]
    ...
    \caption{Schema from \Cref{fig:schema-category} is extended via the \code{createProperty} operation. The change is propagated to the mapping.}
...
As mentioned in \Cref{sec:vision-automation}, the process of evolution propagation can be automated to different degrees.
