...
Our contributions are based on a preexisting approach to multi-model data modeling~\citep{mm_cat}. In this section, we introduce its main concepts and describe how it evolved into a comprehensive multi-model data management framework called \term{MM-cat}. But first, we need to explain the basic theory and terminology we will use throughout the thesis.
