...
\todo{
- možná sloučit vizi a úvod


- úvod (MM-data),
- popis problémů,
- cíle
- možná zmínit, co už bylo řešeno
- jak to chci řešit (krátce)
- pro konkrétní cíle jsou další sekce

- future work? asi až v závěru
}
...
\todo{Přejmenovat na "Cíle" (a možná zmínit i "necíle")

- možná to dát výš?

- potom je zmínit v conclusion
}
