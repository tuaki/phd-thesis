...
Our approach is based on utilizing the toolset we have developed in our research group for various aspects of multi-model data management based on the unifying categorical representation of multi-model data -- the so-called \textit{schema category}~\citep{DBLP:journals/jbd/KoupilH22}. 
...
To grasp the popular models' specific features, we utilize the so-called \textit{schema category}~\citep{DBLP:journals/jbd/KoupilH22}, a unifying abstract categorical representation of multi-model data to manage any possible combination of known models.
